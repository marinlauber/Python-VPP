...
def makevppresults():
    ...
    rudder = Rudder(Cu=data["rudder"]["Cu"], Cl=data["rudder"]["Cu"], Span=data["rudder"]["Cu"])
    main = Main(P=data["main"]["P"], E=data["main"]["E"], Roach=data["main"]["Roach"], BAD=data["main"]["BAD"]),
    jib = Jib(I=data["jib"]["I"], J=data["jib"]["J"], LPG=data["jib"]["LPG"], HBI=data["jib"]["HBI"]),
    ...
    yacht = Yacht(
        ...
        App=[keel, rudder],
        Sails=[
            Main(P=data["main"]["P"], E=data["main"]["E"], Roach=data["main"]["Roach"], BAD=data["main"]["BAD"]),
            Jib(I=data["jib"]["I"], J=data["jib"]["J"], LPG=data["jib"]["LPG"], HBI=data["jib"]["HBI"]),
